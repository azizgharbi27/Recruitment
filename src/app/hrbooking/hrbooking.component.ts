...
@Component({
  selector: 'app-hrbooking',
  templateUrl: './hrbooking.component.html',
  styleUrls: ['./hrbooking.component.scss']
})
export class HRBookingComponent {
...
openDialog(c:Candidate): void {
  ...
  dialogRef.afterClosed().subscribe(result => {
    ...
    this.candidateService.state(c,"booked").subscribe();
